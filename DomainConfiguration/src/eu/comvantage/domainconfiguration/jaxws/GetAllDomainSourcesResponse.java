...
@XmlRootElement(name = "getAllDomainSourcesResponse", namespace = "http://domainconfiguration.comvantage.eu/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getAllDomainSourcesResponse", namespace = "http://domainconfiguration.comvantage.eu/")
