...
@XmlRootElement(name = "wstestSuperComplexResponse", namespace = "http://domainconfiguration.comvantage.eu/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "wstestSuperComplexResponse", namespace = "http://domainconfiguration.comvantage.eu/")
