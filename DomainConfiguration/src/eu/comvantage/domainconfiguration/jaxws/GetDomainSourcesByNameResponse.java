...
@XmlRootElement(name = "getDomainSourcesByNameResponse", namespace = "http://domainconfiguration.comvantage.eu/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getDomainSourcesByNameResponse", namespace = "http://domainconfiguration.comvantage.eu/")
