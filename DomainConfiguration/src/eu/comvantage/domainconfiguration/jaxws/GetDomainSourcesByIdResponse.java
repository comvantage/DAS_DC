...
@XmlRootElement(name = "getDomainSourcesByIdResponse", namespace = "http://domainconfiguration.comvantage.eu/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getDomainSourcesByIdResponse", namespace = "http://domainconfiguration.comvantage.eu/")
