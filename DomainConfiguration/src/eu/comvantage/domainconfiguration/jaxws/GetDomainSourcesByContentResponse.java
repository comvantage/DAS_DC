...
@XmlRootElement(name = "getDomainSourcesByContentResponse", namespace = "http://domainconfiguration.comvantage.eu/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getDomainSourcesByContentResponse", namespace = "http://domainconfiguration.comvantage.eu/")
